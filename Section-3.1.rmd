---
title: "Assignment_2_section-3.1"
...
sales <- read.csv("~/R/rstudio-projects/Assignment2/yearly_sales.csv")
head(sales)
summary(sales)
...
```{r Section 3.1.2}
sales <- read.csv("~/R/rstudio-projects/Assignment2/yearly_sales.csv")
setwd("~/R/rstudio-projects/Assignment2")
sales <- read.csv("~/R/rstudio-projects/Assignment2/yearly_sales.csv")
...
jpeg(file="~/R/rstudio-projects/Assignment2/sales_hist.jpeg") # create a new jpeg file
